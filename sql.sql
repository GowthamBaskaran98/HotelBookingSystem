...
BEGIN	
      --INSERT
      BEGIN
			INSERT INTO HOTELLIST(hotelName, hotelAddress, vacantRoom, roomSize, hotelService, pricePerDay) VALUES (@hotelName,@hotelAddress,@vacantRoom,@roomSize,@hotelService,@pricePerDay)
      END
