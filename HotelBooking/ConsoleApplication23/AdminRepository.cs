...
namespace HotelBooking
{
    ...
    class AdminRepository : HotelManager
    {
        private int count;
        private string name;
        private bool state;
        Storage storage = new Storage();
        HotelManager hotelRepository = new HotelManager();
        public static List<Admin> BookedList = new List<Admin>();
        UserManager detail = new UserManager();
